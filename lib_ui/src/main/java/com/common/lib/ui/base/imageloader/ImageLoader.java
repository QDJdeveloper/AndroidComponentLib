...
public class ImageLoader {
  ...
  public ImageLoader load(@DrawableRes int resId, @DrawableRes int placeholder, @NonNull
  ...
  protected ImageLoader loadImage(Object obj, @DrawableRes int placeholder, Transformation<Bitmap> transformation) {
